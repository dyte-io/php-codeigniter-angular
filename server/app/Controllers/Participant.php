...
class Participant extends ResourceController
{
    ...
    public function create()
    {
        ...
        // Make API call
        try {
            $response = $client->request('POST', 'https://api.dyte.io/v2/meetings/' . $body['meetingId'] . '/participants', [
                'headers' => [
                    'Authorization' => $token,
                ...
                'json' => [
                    ...
                    'custom_participant_id' => $body['email'],
                ]
            ]);
